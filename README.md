...
##### -Создан пакет item, содержащий файлы классов ItemDto, ItemMapper, Item, ItemStorageImpl, ItemService, ItemController и файл интерфейса ItemStorage;  
##### -Создан пакет request, содержащий файлы классов ItemRequestDto, ItemRequestMapper, ItemRequest и ItemRequestController;  
##### -Создан пакет user, содержащий файлы классов UserDto, UserMapper, User, UserStorageImpl и файл интерфейса UserStorage;  
